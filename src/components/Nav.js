...
function Nav() {
  ...
  return (
    <div
      className="sticky top-0 z-20 backdrop-filter backdrop-blur-lg bg-opacity-30
 firefox:bg-opacity-30 text-lg
    bg-gradient-to-r from-red-600 to-blue-700 lg:flex justify-between px-5"
    >
